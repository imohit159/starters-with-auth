...
import { AuthChallenge } from "../../src/database";
import { hashToken } from "../../src/utils/crypto";
import { COOKIE } from "../../src/config/constants";
import { createApp } from "../../src/app";
import { resetTestDb, startTestDb, stopTestDb } from "../helpers/db";

vi.mock("../../src/utils/google-oauth-client", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("../../src/utils/google-oauth-client")>();
  return {
    ...actual,
