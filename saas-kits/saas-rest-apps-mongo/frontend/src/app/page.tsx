    ...
    <main className="flex min-h-svh flex-col items-center justify-center gap-6 px-6">
      <div className="max-w-md text-center">
        <p className="text-xs font-medium tracking-[0.2em] text-muted-foreground uppercase">
          Independent apps + REST
        </p>
        <h1 className="mt-2 text-3xl font-semibold tracking-tight">SaaS starter</h1>
        <p className="mt-3 text-muted-foreground">
          Auth, organizations, Stripe subscriptions, and an org-scoped todo sample. Express and
          Next.js are separate apps — no pnpm workspace. Next.js talks to the API through a
          service layer and axios.
        </p>
      </div>
