    ...
    <main className="flex min-h-svh flex-col items-center justify-center gap-6 px-6">
      <div className="max-w-md text-center">
        ...
        <p className="mt-3 text-muted-foreground">
          Auth, organizations, Stripe subscriptions, and an org-scoped todo sample. Express hosts
          tRPC. Next.js imports <code className="text-foreground">AppRouter</code> types from the
          workspace.
        </p>
      </div>
